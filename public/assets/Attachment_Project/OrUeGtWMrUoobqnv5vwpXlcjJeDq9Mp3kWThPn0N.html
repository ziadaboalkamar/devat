...
$(function () {
    ...
    var dtUserTable = $('.user-list-table'),
        ...
        dtNatureTable = $('.nature-list-table'),
        dtFieldTable = $('.field-list-table'),
    ...
    if (dtNatureTable.length) {
        dtNatureTable.DataTable({
            ajax: assetPath + 'data/user-list.json', // JSON file to add data
            columns: [
                // columns according to JSON
                {data: 'responsive_id'},
    ...
    if (dtFieldTable.length) {
        dtFieldTable.DataTable({
            ajax: assetPath + 'data/user-list.json', // JSON file to add data
            columns: [
                // columns according to JSON
                {data: 'responsive_id'},
