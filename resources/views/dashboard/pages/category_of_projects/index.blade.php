...
@section('title', 'الصفحة الرئيسية للمنح')
@section('css')
            ...
            <div class="content-body">
                <div class="content-wrapper">
                    ...
                    <div class="content-body">
                        ...
                        <form action="{{ route('category-of-projects.create') }}" method="get" class="d-none"
                            id="create_new">
                            @csrf
                            <button type="submit"></button>

                        </form>
                        @foreach ($categoriesOfProjects as $categoriesOfProject)
                            <!-- Modal -->
                            <div class="modal fade" id="delete{{ $categoriesOfProject->id }}" tabindex="-1"
                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel"> حذف المنحة <span class="text-primary">{{ $categoriesOfProject->name }}</span></h5>
                                        ...
                                        <form
                                            action="{{ route('category-of-projects.destroy', $categoriesOfProject->id) }}"
                                            method="post">
                                            {{ method_field('delete') }}
                                            {{ csrf_field() }}
                ...
                // Actions
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return (
                            ...
                            '<a href="category-of-projects/' + id + '/edit" class="dropdown-item">' +
