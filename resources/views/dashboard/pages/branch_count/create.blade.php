                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row invoice-repeater"
                                        action="{{ route('projects.branchCount.store', $project_id) }}" method="POST"
                                        id="create_new">
                                        @csrf
                                                    ...
                                                    <div class="row d-flex align-items-end">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="beneficiaries_count"
                                                                    ...
                                                                    class="form-control prefix-mask" id="basicInputFile" />
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="count" value="{{ old('count') }}"
                                                                    ...
                                                                    placeholder="الكمية المخصصة" id="credit-card" />
                                                                @error('count')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" value="{{ old('deadline_date') }}"
                                                                    name="deadline_date"
                                                                    class="form-control credit-card-mask"
                                                                    placeholder="الكمية المخصصة" id="credit-card" />
                                                                @error('deadline_date')
                                        ...
                                        <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                                            ...
                                            <a href="{{ route('projects.branchCount.index',$project_id) }}" class="btn btn-outline-secondary">اغلاق</a>
