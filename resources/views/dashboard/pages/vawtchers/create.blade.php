...
@section('title','اضافة قسيمة شرائية جديد')
@section('css')
@stop
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">اضافة قسيمة شرائية </h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">اضافة قسيمة شرائية
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row" action="{{ route('vawtchers.store') }}" method="POST" id="create_new">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            ...
                                            <input type="number" name="ammount" value="{{ old('ammount') }}" class="form-control credit-card-mask" placeholder="السعر"  />
                                        ...
                                        <div class="col-xl-8 col-md-6 col-sm-12 mb-2">
                                           <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="text" id="text" rows="3" placeholder="محتوى القسيمة">{{ old('text') }}</textarea>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                           <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="note" id="text" rows="3" placeholder="ملاحظة ">{{ old('note') }}</textarea>
